...
const MenuManagement = () => {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', 'menu management, restaurant menu, menu control, dynamic pricing, menu items, menu categories, menu updates, SavoryOps'.replaceAll('SavoryOps', softwareName));
  }, [softwareName]);
