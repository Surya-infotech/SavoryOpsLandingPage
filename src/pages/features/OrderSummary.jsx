...
const OrderSummary = () => {
  ...
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', 'order summary, order tracking, order management, order timeline, order history, order reports, restaurant orders, SavoryOps'.replaceAll('SavoryOps', softwareName));
  }, [softwareName]);
